...
class AllSensors
{
	public:
		...
		OneSensor list[SENSOR_COUNT+1] {
			...
			OneSensor { BOARD_AUX,		100,	SENSOR_ATLAS_EC_TDS,			"AS_TDS",		"Atlas Total Dissolved Solids",			122,		false,		true,		1,			"ppm"},
			OneSensor { BOARD_AUX,		100,	SENSOR_ATLAS_EC_SAL,			"AS_SAL",		"Atlas Salinity",				123,		false,		true,		1,			"PSU(ppt)"},
			...
			OneSensor { BOARD_AUX,		100,	SENSOR_ADS1X15_48_0,			"ADC_48_0",		"ADS1x15 ADC 0x48 Ch0",				0,		false,		true,		1,			"V"},
			OneSensor { BOARD_AUX,		100,	SENSOR_ADS1X15_48_1,			"ADC_48_1",		"ADS1x15 ADC 0x48 Ch1",				0,		false,		true,		1,			"V"},
			OneSensor { BOARD_AUX,		100,	SENSOR_ADS1X15_48_2,			"ADC_48_2",		"ADS1x15 ADC 0x48 Ch2",				0,		false,		true,		1,			"V"},
			OneSensor { BOARD_AUX,		100,	SENSOR_ADS1X15_48_3,			"ADC_48_3",		"ADS1x15 ADC 0x48 Ch3",				0,		false,		true,		1,			"V"},
			OneSensor { BOARD_AUX,		100,	SENSOR_ADS1X15_49_0,			"ADC_49_0",		"ADS1x15 ADC 0x49 Ch0",				0,		false,		true,		1,			"V"},
			OneSensor { BOARD_AUX,		100,	SENSOR_ADS1X15_49_1,			"ADC_49_1",		"ADS1x15 ADC 0x49 Ch1",				0,		false,		true,		1,			"V"},
			OneSensor { BOARD_AUX,		100,	SENSOR_ADS1X15_49_2,			"ADC_49_2",		"ADS1x15 ADC 0x49 Ch2",				0,		false,		true,		1,			"V"},
			OneSensor { BOARD_AUX,		100,	SENSOR_ADS1X15_49_3,			"ADC_49_3",		"ADS1x15 ADC 0x49 Ch3",				0,		false,		true,		1,			"V"},
			OneSensor { BOARD_AUX,		100,	SENSOR_ADS1X15_4A_0,			"ADC_4A_0",		"ADS1x15 ADC 0x4A Ch0",				0,		false,		true,		1,			"V"},
			OneSensor { BOARD_AUX,		100,	SENSOR_ADS1X15_4A_1,			"ADC_4A_1",		"ADS1x15 ADC 0x4A Ch1",				0,		false,		true,		1,			"V"},
			OneSensor { BOARD_AUX,		100,	SENSOR_ADS1X15_4A_2,			"ADC_4A_2",		"ADS1x15 ADC 0x4A Ch2",				0,		false,		true,		1,			"V"},
			OneSensor { BOARD_AUX,		100,	SENSOR_ADS1X15_4A_3,			"ADC_4A_3",		"ADS1x15 ADC 0x4A Ch3",				0,		false,		true,		1,			"V"},
			OneSensor { BOARD_AUX,		100,	SENSOR_ADS1X15_4B_0,			"ADC_4B_0",		"ADS1x15 ADC 0x4B Ch0",				0,		false,		true,		1,			"V"},
			OneSensor { BOARD_AUX,		100,	SENSOR_ADS1X15_4B_1,			"ADC_4B_1",		"ADS1x15 ADC 0x4B Ch1",				0,		false,		true,		1,			"V"},
			OneSensor { BOARD_AUX,		100,	SENSOR_ADS1X15_4B_2,			"ADC_4B_2",		"ADS1x15 ADC 0x4B Ch2",				0,		false,		true,		1,			"V"},
			OneSensor { BOARD_AUX,		100,	SENSOR_ADS1X15_4B_3,			"ADC_4B_3",		"ADS1x15 ADC 0x4B Ch3",				0,		false,		true,		1,			"V"},
