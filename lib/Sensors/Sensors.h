...
class AllSensors
{
	public:
		...
		OneSensor list[SENSOR_COUNT+1] {
			...
			OneSensor { BOARD_URBAN,	240,	SENSOR_PM_1UAE,				"PM_1UAE",		"PM 1.0 Under Atmos Envir",			0,		true,		false,		1,			"ug/m3"},
			OneSensor { BOARD_URBAN,	240,	SENSOR_PM_25UAE,			"PM_25UAE",		"PM 2.5 Under Atmos Envir",			0,		true,		false,		1,			"ug/m3"},
			OneSensor { BOARD_URBAN,	240,	SENSOR_PM_10UAE,			"PM_10UAE",		"PM 10.0 Under Atmo Envir",			0,		true,		false,		1,			"ug/m3"},
			...
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_PM_1,			"EXT_PM_1",		"External PM 1.0",				89,		false,		false,		1,			"ug/m3"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_PM_25,			"EXT_PM_25",		"External PM 2.5",				87,		false,		false,		1,			"ug/m3"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_PM_10,			"EXT_PM_10",		"External PM 10.0",				88,		false,		false,		1,			"ug/m3"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_PM_1UAE,			"EXT_PM_1UAE",		"External PM 1.0 Under Atmos Envir",		0,		false,		false,		1,			"ug/m3"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_PM_25UAE,			"EXT_PM_25UAE",		"External PM 2.5 Under Atmos Envir",		0,		false,		false,		1,			"ug/m3"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_PM_10UAE,			"EXT_PM_10UAE",		"External PM 10.0 Under Atmos Envir",		0,		false,		false,		1,			"ug/m3"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_PN_03,			"EXT_PN_03",		"External PN 0.3",				0,		false,		false,		1,			"#/0.1l"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_PN_05,			"EXT_PN_05",		"External PN 0.5",				0,		false,		false,		1,			"#/0.1l"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_PN_1,			"EXT_PN_1",		"External PN 1.0",				0,		false,		false,		1,			"#/0.1l"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_PN_25,			"EXT_PN_25",		"External PN 2.5",				0,		false,		false,		1,			"#/0.1l"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_PN_5,			"EXT_PN_5",		"External PN 5.0",				0,		false,		false,		1,			"#/0.1l"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_PN_10,			"EXT_PN_10",		"External PN 10.0",				0,		false,		false,		1,			"#/0.1l"},

			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_A_PM_1,			"EXT_PM_A_1",		"External PM_A 1.0",				0,		false,		false,		1,			"ug/m3"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_A_PM_25,			"EXT_PM_A_25",		"External PM_A 2.5",				0,		false,		false,		1,			"ug/m3"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_A_PM_10,			"EXT_PM_A_10",		"External PM_A 10.0",				0,		false,		false,		1,			"ug/m3"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_A_PM_1UAE,			"EXT_PM_A_1UAE",	"External PM_A 1.0 Under Atmos Envir",		0,		false,		false,		1,			"ug/m3"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_A_PM_25UAE,			"EXT_PM_A_25UAE",	"External PM_A 2.5 Under Atmos Envir",		0,		false,		false,		1,			"ug/m3"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_A_PM_10UAE,			"EXT_PM_A_10UAE",	"External PM_A 10.0 Under Atmos Envir",		0,		false,		false,		1,			"ug/m3"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_A_PN_03,			"EXT_PN_A_03",		"External PN_A 0.3",				0,		false,		false,		1,			"#/0.1l"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_A_PN_05,			"EXT_PN_A_05",		"External PN_A 0.5",				0,		false,		false,		1,			"#/0.1l"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_A_PN_1,			"EXT_PN_A_1",		"External PN_A 1.0",				0,		false,		false,		1,			"#/0.1l"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_A_PN_25,			"EXT_PN_A_25",		"External PN_A 2.5",				0,		false,		false,		1,			"#/0.1l"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_A_PN_5,			"EXT_PN_A_5",		"External PN_A 5.0",				0,		false,		false,		1,			"#/0.1l"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_A_PN_10,			"EXT_PN_A_10",		"External PN_A 10.0",				0,		false,		false,		1,			"#/0.1l"},

			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_B_PM_1,			"EXT_PM_B_1",		"External PM_B 1.0",				0,		false,		false,		1,			"ug/m3"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_B_PM_25,			"EXT_PM_B_25",		"External PM_B 2.5",				0,		false,		false,		1,			"ug/m3"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_B_PM_10,			"EXT_PM_B_10",		"External PM_B 10.0",				0,		false,		false,		1,			"ug/m3"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_B_PM_1UAE,			"EXT_PM_B_1UAE",	"External PM_B 1.0 Under Atmos Envir",		0,		false,		false,		1,			"ug/m3"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_B_PM_25UAE,			"EXT_PM_B_25UAE",	"External PM_B 2.5 Under Atmos Envir",		0,		false,		false,		1,			"ug/m3"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_B_PM_10UAE,			"EXT_PM_B_10UAE",	"External PM_B 10.0 Under Atmos Envir",		0,		false,		false,		1,			"ug/m3"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_B_PN_03,			"EXT_PN_B_03",		"External PN_B 0.3",				0,		false,		false,		1,			"#/0.1l"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_B_PN_05,			"EXT_PN_B_05",		"External PN_B 0.5",				0,		false,		false,		1,			"#/0.1l"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_B_PN_1,			"EXT_PN_B_1",		"External PN_B 1.0",				0,		false,		false,		1,			"#/0.1l"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_B_PN_25,			"EXT_PN_B_25",		"External PN_B 2.5",				0,		false,		false,		1,			"#/0.1l"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_B_PN_5,			"EXT_PN_B_5",		"External PN_B 5.0",				0,		false,		false,		1,			"#/0.1l"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_B_PN_10,			"EXT_PN_B_10",		"External PN_B 10.0",				0,		false,		false,		1,			"#/0.1l"},
			...
			OneSensor { BOARD_AUX,		0,	SENSOR_SHT31_TEMP,			"EXT_TEMP",		"External Temperature",				79,		false,		false,		1,			"C"},
			OneSensor { BOARD_AUX,		0,	SENSOR_SHT31_HUM,			"EXT_HUM",		"External Humidity",				80,		false,		false,		1,			"%"},

			OneSensor { BOARD_AUX,		100,	SENSOR_RANGE_LIGHT,			"EXT_RANGE_LIGHT",	"External Range Light",				0,		false,		false,		1,			"Lux"},
			OneSensor { BOARD_AUX,		100,	SENSOR_RANGE_DISTANCE,			"EXT_RANGE_DIST",	"External Range Distance",			98,		false,		false,		1,			"mm"},
