...
class AllSensors
{
    public:
        ...
        OneSensor list[SENSOR_COUNT+1] {
            ...
            OneSensor { BOARD_URBAN,    100,    SENSOR_SPS30_PM_1,              "SPS30_PM_1",       "SPS30 PM 1.0",                         182,    true,       true,       1,  "ug/m3"     },
            OneSensor { BOARD_URBAN,    100,    SENSOR_SPS30_PM_25,             "SPS30_PM_25",      "SPS30 PM 2.5",                         183,    true,       true,       1,  "ug/m3"     },
            OneSensor { BOARD_URBAN,    100,    SENSOR_SPS30_PM_4,              "SPS30_PM_4",       "SPS30 PM 4.0",                         184,    true,       true,       1,  "ug/m3"     },
            OneSensor { BOARD_URBAN,    100,    SENSOR_SPS30_PM_10,             "SPS30_PM_10",      "SPS30 PM 10.0",                        185,    true,       true,       1,  "ug/m3"     },
            OneSensor { BOARD_URBAN,    100,    SENSOR_SPS30_PN_05,             "SPS30_PN_05",      "SPS30 PN 0.5",                         186,    true,       true,       1,  "#/0.1l"    },
            OneSensor { BOARD_URBAN,    100,    SENSOR_SPS30_PN_1,              "SPS30_PN_1",       "SPS30 PN 1.0",                         187,    true,       true,       1,  "#/0.1l"    },
            OneSensor { BOARD_URBAN,    100,    SENSOR_SPS30_PN_25,             "SPS30_PN_25",      "SPS30 PN 2.5",                         188,    true,       true,       1,  "#/0.1l"    },
            OneSensor { BOARD_URBAN,    100,    SENSOR_SPS30_PN_4,              "SPS30_PN_4",       "SPS30 PN 4.0",                         189,    true,       true,       1,  "#/0.1l"    },
            OneSensor { BOARD_URBAN,    100,    SENSOR_SPS30_PN_10,             "SPS30_PN_10",      "SPS30 PN 10.0",                        190,    true,       true,       1,  "#/0.1l"    },
            OneSensor { BOARD_URBAN,    100,    SENSOR_SPS30_TPSIZE,            "SPS30_TPSIZE",     "SPS30 Typical Partical Size",          191,    true,       true,       1,  "um"        },


            OneSensor { BOARD_URBAN,    100,    SENSOR_SEN5X_PM_1,              "SEN5X_PM_1",       "SEN5X PM 1.0",                         193,    true,       true,       1,  "ug/m3"     },
            OneSensor { BOARD_URBAN,    100,    SENSOR_SEN5X_PM_25,             "SEN5X_PM_25",      "SEN5X PM 2.5",                         194,    true,       true,       1,  "ug/m3"     },
            OneSensor { BOARD_URBAN,    100,    SENSOR_SEN5X_PM_4,              "SEN5X_PM_4",       "SEN5X PM 4.0",                         195,    true,       true,       1,  "ug/m3"     },
            OneSensor { BOARD_URBAN,    100,    SENSOR_SEN5X_PM_10,             "SEN5X_PM_10",      "SEN5X PM 10.0",                        196,    true,       true,       1,  "ug/m3"     },
            OneSensor { BOARD_URBAN,    100,    SENSOR_SEN5X_PN_05,             "SEN5X_PN_05",      "SEN5X PN 0.5",                         197,    true,       true,       1,  "#/0.1l"    },
            OneSensor { BOARD_URBAN,    100,    SENSOR_SEN5X_PN_1,              "SEN5X_PN_1",       "SEN5X PN 1.0",                         198,    true,       true,       1,  "#/0.1l"    },
            OneSensor { BOARD_URBAN,    100,    SENSOR_SEN5X_PN_25,             "SEN5X_PN_25",      "SEN5X PN 2.5",                         199,    true,       true,       1,  "#/0.1l"    },
            OneSensor { BOARD_URBAN,    100,    SENSOR_SEN5X_PN_4,              "SEN5X_PN_4",       "SEN5X PN 4.0",                         200,    true,       true,       1,  "#/0.1l"    },
            OneSensor { BOARD_URBAN,    100,    SENSOR_SEN5X_PN_10,             "SEN5X_PN_10",      "SEN5X PN 10.0",                        201,    true,       true,       1,  "#/0.1l"    },
            OneSensor { BOARD_URBAN,    100,    SENSOR_SEN5X_TPSIZE,            "SEN5X_TPSIZE",     "SEN5X Typical Partical Size",          202,    true,       true,       1,  "um"        },
            OneSensor { BOARD_URBAN,    100,    SENSOR_SEN5X_HUMIDITY,          "SEN5X_HUM",        "SEN5X Humidity",                       203,    true,       true,       1,  "%"         },
            OneSensor { BOARD_URBAN,    100,    SENSOR_SEN5X_TEMPERATURE,       "SEN5X_TEMP",       "SEN5X Temperature",                    204,    true,       true,       1,  "C"         },
            OneSensor { BOARD_URBAN,    100,    SENSOR_SEN5X_VOCS_IDX,          "SEN5X_VOCS_IDX",   "SEN5X Vocs Index",                     205,    true,       true,       1,              },
            OneSensor { BOARD_URBAN,    100,    SENSOR_SEN5X_NOX_IDX,           "SEN5X_NOX_IDX",    "SEN5X NOx Index",                      206,    true,       true,       1,              },
            OneSensor { BOARD_URBAN,    100,    SENSOR_SEN5X_HUMIDITY_RAW,      "SEN5X_HUM_RAW",    "SEN5X Humidity Raw",                   0,      true,       true,       1,              },
            OneSensor { BOARD_URBAN,    100,    SENSOR_SEN5X_TEMPERATURE_RAW,   "SEN5X_TEMP_RAW",   "SEN5X Temperature Raw",                0,      true,       true,       1,              },
            OneSensor { BOARD_URBAN,    100,    SENSOR_SEN5X_VOCS_RAW,          "SEN5X_VOCS_RAW",   "SEN5X Vocs Raw",                       207,    true,       true,       1,              },
            OneSensor { BOARD_URBAN,    100,    SENSOR_SEN5X_NOX_RAW,           "SEN5X_NOX_RAW",    "SEN5X NOx Raw",                        208,    true,       true,       1,              },
