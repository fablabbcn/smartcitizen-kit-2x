...
class AllSensors
{
	public:
		...
		OneSensor list[SENSOR_COUNT+1] {
			...
			OneSensor { BOARD_URBAN,	240,	SENSOR_PM_1UAE,				"PM_1UAE",		"PM 1.0 Under atm env",				0,		true,		false,		1,			"ug/m3"},
			OneSensor { BOARD_URBAN,	240,	SENSOR_PM_25UAE,			"PM_25UAE",		"PM 2.5 Under atm env",				0,		true,		false,		1,			"ug/m3"},
			OneSensor { BOARD_URBAN,	240,	SENSOR_PM_10UAE,			"PM_10UAE",		"PM 10.0 Under atm env",			0,		true,		false,		1,			"ug/m3"},
			...
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_PM_1UAE,			"EXT_PM_1UAE",		"Ext PM 1.0 Under atm env",			0,		false,		false,		1,			"ug/m3"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_PM_25UAE,			"EXT_PM_25UAE",		"Ext PM 2.5 Under atm env",			0,		false,		false,		1,			"ug/m3"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_PM_10UAE,			"EXT_PM_10UAE",		"Ext PM 10.0 Under atm env",			0,		false,		false,		1,			"ug/m3"},
			...
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_A_PM_1UAE,			"EXT_PM_A_1UAE",	"Ext PM_A 1.0 Under atm env",			0,		false,		false,		1,			"ug/m3"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_A_PM_25UAE,			"EXT_PM_A_25UAE",	"Ext PM_A 2.5 Under atm env",			0,		false,		false,		1,			"ug/m3"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_A_PM_10UAE,			"EXT_PM_A_10UAE",	"Ext PM_A 10.0 Under atm env",			0,		false,		false,		1,			"ug/m3"},
			...
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_B_PM_1UAE,			"EXT_PM_B_1UAE",	"Ext PM_B 1.0 Under atm env",			0,		false,		false,		1,			"ug/m3"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_B_PM_25UAE,			"EXT_PM_B_25UAE",	"Ext PM_B 2.5 Under atm env",			0,		false,		false,		1,			"ug/m3"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_B_PM_10UAE,			"EXT_PM_B_10UAE",	"Ext PM_B 10.0 Under atm env",			0,		false,		false,		1,			"ug/m3"},
