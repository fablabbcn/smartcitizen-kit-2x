...
class AllSensors
{
	public:
		...
		OneSensor list[SENSOR_COUNT+1] {
			...
			OneSensor { BOARD_AUX,		100,	SENSOR_ENS160_AIQ,			"ENS160_AIQ",		"ENS160 Air Quality Index", 		0,		true,		false,		1,			""},
			OneSensor { BOARD_AUX,		100,	SENSOR_ENS160_TVOC,			"ENS160_TVOC",		"ENS160 Total Organic Volatile Compounds",0,true,		false,		1,			"ppb"},
			OneSensor { BOARD_AUX,		100,	SENSOR_ENS160_ECO2,			"ENS160_ECO2",		"ENS160 Equivalent CO2", 			0,		true,		false,		1,			"ppm"},
			OneSensor { BOARD_AUX,		100,	SENSOR_ENS160_ETOH,			"ENS160_ETOH",		"ENS160 Ethanol", 					0,		true,		false,		1,			"ppb"},
