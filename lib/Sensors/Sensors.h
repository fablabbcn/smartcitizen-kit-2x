...
class AllSensors
{
	public:
		...
		OneSensor list[SENSOR_COUNT+1] {
			...
			OneSensor { BOARD_AUX,		100,	SENSOR_SI115X_UV,			"SI115X_UV",		"SI115X UV light",		 		0,			true,		true,		1,			""},
			OneSensor { BOARD_AUX,		100,	SENSOR_SI115X_IR,			"SI115X_IR",		"SI115X Infra red light", 		0,			true,		true,		1,			""},
			OneSensor { BOARD_AUX,		100,	SENSOR_SI115X_VISIBLE,		"SI115X_VIS",		"SI115X Visible light", 		0,			true,		true,		1,			""},
			OneSensor { BOARD_AUX,		100,	SENSOR_SI115X_PROX,			"SI115X_PROX",		"SI115X Proximity",		 		0,			true,		true,		1,			""},
