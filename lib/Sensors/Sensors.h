...
enum SensorType
{
	...
	SENSOR_PN_5,
	SENSOR_PN_10,
	SENSOR_PM_FORMALDEHYDE,
	SENSOR_PM_TEMPERATURE,
	SENSOR_PM_HUMIDITY,
...
class AllSensors
{
	public:
		...
		OneSensor list[SENSOR_COUNT+1] {
			...
			OneSensor { BOARD_URBAN,	240,	SENSOR_PM_1,				"PM_1",			"PM 1.0",					89,		true,		true,		1, 			"ug/m3"},
			OneSensor { BOARD_URBAN,	240,	SENSOR_PM_25,				"PM_25",		"PM 2.5",					87,		true,		true,		1, 			"ug/m3"},
			OneSensor { BOARD_URBAN,	240,	SENSOR_PM_10,				"PM_10",		"PM 10.0",					88,		true,		true,		1, 			"ug/m3"},
			...
			OneSensor { BOARD_URBAN,	240,	SENSOR_PM_FORMALDEHYDE,			"PM_FORM",		"PM Formaldehyde",				0,		true,		true,		1, 			"ug/m3"},
			OneSensor { BOARD_URBAN,	240,	SENSOR_PM_TEMPERATURE,			"PM_TEMP",		"PM Temperature",				0,		true,		true,		1, 			"C"},
			OneSensor { BOARD_URBAN,	240,	SENSOR_PM_HUMIDITY,			"PM_HUM",		"PM Humidity",					0,		true,		true,		1, 			"%"},
