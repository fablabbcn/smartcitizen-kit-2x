...
class AllSensors
{
	public:
		...
		OneSensor list[SENSOR_COUNT+1] {
			...
			OneSensor { BOARD_AUX,		100,	SENSOR_ATLAS_EC_TDS,			"AS_TDS",		"Atlas Total Dissolved Solids",			0,		false,		true,		1,			"ppm"},
			OneSensor { BOARD_AUX,		100,	SENSOR_ATLAS_EC_SAL,			"AS_SAL",		"Atlas Salinity",				0,		false,		true,		1,			"PSU(ppt)"},
