...
class AllSensors
{
	public:
		...
		OneSensor list[SENSOR_COUNT+1] {
			...
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_PM_1,			"EXT_PM_1",		"Ext PM 1.0",					89,		true,		false,		1,			"ug/m3"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_PM_25,			"EXT_PM_25",		"Ext PM 2.5",					87,		true,		false,		1,			"ug/m3"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_PM_10,			"EXT_PM_10",		"Ext PM 10.0",					88,		true,		false,		1,			"ug/m3"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_PN_03,			"EXT_PN_03",		"Ext PN 0.3",					0,		true,		false,		1,			"#/0.1l"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_PN_05,			"EXT_PN_05",		"Ext PN 0.5",					0,		true,		false,		1,			"#/0.1l"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_PN_1,			"EXT_PN_1",		"Ext PN 1.0",					0,		true,		false,		1,			"#/0.1l"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_PN_25,			"EXT_PN_25",		"Ext PN 2.5",					0,		true,		false,		1,			"#/0.1l"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_PN_5,			"EXT_PN_5",		"Ext PN 5.0",					0,		true,		false,		1,			"#/0.1l"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_PN_10,			"EXT_PN_10",		"Ext PN 10.0",					0,		true,		false,		1,			"#/0.1l"},
			...
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_A_PN_03,			"EXT_PN_A_03",		"Ext PN_A 0.3",					99,		true,		false,		1,			"#/0.1l"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_A_PN_05,			"EXT_PN_A_05",		"Ext PN_A 0.5",					100,		true,		false,		1,			"#/0.1l"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_A_PN_1,			"EXT_PN_A_1",		"Ext PN_A 1.0",					101,		true,		false,		1,			"#/0.1l"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_A_PN_25,			"EXT_PN_A_25",		"Ext PN_A 2.5",					102,		true,		false,		1,			"#/0.1l"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_A_PN_5,			"EXT_PN_A_5",		"Ext PN_A 5.0",					103,		true,		false,		1,			"#/0.1l"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_A_PN_10,			"EXT_PN_A_10",		"Ext PN_A 10.0",				104,		true,		false,		1,			"#/0.1l"},
			...
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_B_PN_03,			"EXT_PN_B_03",		"Ext PN_B 0.3",					105,		true,		false,		1,			"#/0.1l"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_B_PN_05,			"EXT_PN_B_05",		"Ext PN_B 0.5",					106,		true,		false,		1,			"#/0.1l"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_B_PN_1,			"EXT_PN_B_1",		"Ext PN_B 1.0",					107,		true,		false,		1,			"#/0.1l"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_B_PN_25,			"EXT_PN_B_25",		"Ext PN_B 2.5",					108,		true,		false,		1,			"#/0.1l"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_B_PN_5,			"EXT_PN_B_5",		"Ext PN_B 5.0",					109,		true,		false,		1,			"#/0.1l"},
			OneSensor { BOARD_AUX,		200,	SENSOR_EXT_B_PN_10,			"EXT_PN_B_10",		"Ext PN_B 10.0",				110,		true,		false,		1,			"#/0.1l"},
