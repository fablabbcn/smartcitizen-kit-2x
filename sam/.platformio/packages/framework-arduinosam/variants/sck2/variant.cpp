 ...
 * | 7          |  PA21  | CONTROL         |                 | EIC/EXTINT[5]                        PTC/X[9]  SERCOM5/PAD[3]  SERCOM3/PAD[3]              TCC0/WO[7]
 * +------------+--------+-----------------+-----------------+--------------------------------------------------------------------------------------------------------
 * |            |        |                 |                 |
 * +------------+--------+-----------------+-----------------+--------------------------------------------------------------------------------------------------------
 * | 8          |  PA06  | OTG             |                 | EIC/EXTINT[6]  ADC/AIN[6]  AC/AIN[2] PTC/Y[4]  SERCOM0/PAD[2]                  TCC1/WO[0]
 ...
 * |            |        |                 |                 |
 * +------------+--------+-----------------+-----------------+--------------------------------------------------------------------------------------------------------
 * | 14         |  PA02  | ALARMB          |                 | EIC/EXTINT[2]  ADC/AIN[0]  DAC/VOUT  PTC/Y[0]
 ...
 * | 17         |  PA04  | TX_WIFI         | SERCOM0/PAD[0]  | EIC/EXTINT[4]  ADC/AIN[4]  AC/AIN[0] PTC/Y[2]  SERCOM0/PAD[0]                  TCC0/WO[0]
 * | 18         |  PA05  | RX_WIFI         | SERCOM0/PAD[1]  | EIC/EXTINT[5]  ADC/AIN[5]  AC/AIN[1] PTC/Y[5]  SERCOM0/PAD[1]                  TCC0/WO[1]
 * | 19         |  PB02  | TX_PMS          |                 | EIC/EXTINT[2]  ADC/AIN[10]           PTC/Y[8]  SERCOM5/PAD[0]
 * +------------+--------+-----------------+-----------------+--------------------------------------------------------------------------------------------------------
 * |            |        |                 |                 |
 * +------------+--------+-----------------+-----------------+--------------------------------------------------------------------------------------------------------
...
const PinDescription g_APinDescription[]=
{
  ...
  /* { PORTA, 20, PIO_PWM, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM), No_ADC_Channel, PWM0_CH6, NOT_ON_TIMER, EXTERNAL_INT_NONE },                   // LED_RED */
  ...
  { PORTA, 21, PIO_DIGITAL, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_5 },                               // CONTROL
  { PORTA,  6, PIO_DIGITAL, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER), No_ADC_Channel, PWM1_CH0, TCC1_CH0, EXTERNAL_INT_6 },       // OTG
  ...
  /* { PORTA, 18, PIO_PWM, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM), No_ADC_Channel, PWM3_CH0, NOT_ON_TIMER, EXTERNAL_INT_NONE },                   // LED_BLUE */
  ...
  { PORTA,  2, PIO_DIGITAL, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_2 }, // ALARMB
  ...
  // { PORTB,  2, PIO_SERCOM, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE },                             // TX_PMS   SERCOM_ALT5/PAD[0]
  ...
  // { PORTB,  3, PIO_SERCOM, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE },                             // RX_PMS   SERCOM_ALT5/PAD[1]
  { PORTB,  3, PIO_ANALOG, 0, ADC_Channel11, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE}, // ADC/AIN[10]
  ...
  { PORTA, 19, PIO_PWM, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM), No_ADC_Channel, PWM0_CH3, NOT_ON_TIMER, EXTERNAL_INT_NONE },                   // *** LED_GREEN
  { PORTA, 16, PIO_SERCOM, PIN_ATTR_NONE, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE },                                // *** SDA_B: SERCOM1/PAD[0]
  { PORTA, 18, PIO_PWM, PIN_ATTR_NONE, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE },                                   // *** LED_BLUE
  { PORTA, 17, PIO_SERCOM, PIN_ATTR_NONE, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE },                                // *** SCL_B: SERCOM1/PAD[1]

  { PORTA, 13, PIO_DIGITAL, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_13 },                              // SPI_CS_Flash

  // Arduino defined...
  { PORTA, 21, PIO_DIGITAL, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE },                            // *** CONTROL
  { PORTA,  6, PIO_DIGITAL, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM), No_ADC_Channel, PWM1_CH0, NOT_ON_TIMER, EXTERNAL_INT_NONE },               // *** OTG
  { PORTA,  7, PIO_COM, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE },     			        // *** I2S_SD

  { PORTA, 3, PIO_DIGITAL, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_3 },                                // INT_CHG

  // Arduino defined...
  { PORTA, 2, PIO_ANALOG, PIN_ATTR_ANALOG, DAC_Channel0, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_2 }                                     // ALARMB

  // // Urban Board Header
  // // ----------------------
  // // 0, 1, 9 - I2S Digital Mic FALTA CONFIGURAR I2S
  // { PORTA, 11, PIO_COM, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_11 },  // I2S_FS
  // { PORTA, 10, PIO_COM, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_10 },  // I2S_SCK
  // { PORTA,  7, PIO_COM, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_7 },   // I2S_SD
  
  // 20, 21 - I2C pins (SDA/SCL) I2C Main bus
  // { PORTA, 22, PIO_SERCOM, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_6 },  // SDA_A: SERCOM3/PAD[0]
  // { PORTA, 23, PIO_SERCOM, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_7 },  // SCL_A: SERCOM3/PAD[1]

  // // 19, 25 - MICS Analog read pins
  // { PORTB,  2, PIO_ANALOG, 0, ADC_Channel10, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE },   // READ_NOX
  // { PORTB,  3, PIO_ANALOG, 0, ADC_Channel11, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE },   // READ_CO

  // // 4, 3 - MICS PWM Heater control
  // { PORTA,  8, PIO_TIMER, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER), No_ADC_Channel, PWM0_CH0, TCC0_CH0, EXTERNAL_INT_NMI },   // HEAT_CO
  // { PORTA,  9, PIO_TIMER, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER), No_ADC_Channel, PWM0_CH1, TCC0_CH1, EXTERNAL_INT_9 },     // HEAT_NO2


  // // ESP Wifi module
  // // ----------------------
  // // 17, 18, 30 - ESP control pins
  // { PORTA,  4, PIO_OUTPUT, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_4 },    // CH_PD
  // { PORTA,  5, PIO_OUTPUT, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE },    // GPIO0
  // { PORTB, 22, PIO_OUTPUT, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE },    // P_WIFI 

  // // 15, 16 - ESP Serial port (for now this should be a SoftwareSerial)
  // { PORTB,  8, PIO_DIGITAL, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER), No_ADC_Channel, PWM4_CH0, TC4_CH0, EXTERNAL_INT_8 },  // TX_WIFI (should use SERCOM4:0)
  // { PORTB,  9, PIO_DIGITAL, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER), No_ADC_Channel, PWM4_CH1, TC4_CH1, EXTERNAL_INT_9 },  // RX_WIFI (should use SERCOM4:1)


  // // SPI bus
  // // ---------------------- 
  // // 22, 23, 24 - SPI bus 
  // { PORTA, 12, PIO_SERCOM_ALT, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_12 }, // SPI_MISO: SERCOM4/PAD[0]
  // { PORTB, 10, PIO_SERCOM_ALT, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_10 }, // SPI_MOSI: SERCOM4/PAD[2]
  // { PORTB, 11, PIO_SERCOM_ALT, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_11 }, // SPI_SCK: SERCOM4/PAD[3]

  // // 38, 2 - Chip Select for flash memory and SDcard
  // { PORTA, 13, PIO_DIGITAL, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_13 }, // SPI_CS_Flash
  // { PORTA, 14, PIO_DIGITAL, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_14 }, // SPI_CS_SDcard
  ...
  // // I2C Auxiliary bus
  // // ----------------------
  // // 11, 13 - I2C pins (SDA/SCL) I2C Auxiliary bus
  // { PORTA, 16, PIO_SERCOM, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_0 },  // SDA_B: SERCOM1:PAD[0]
  // { PORTA, 17, PIO_SERCOM, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_1 },  // SCL_B: SERCOM1/PAD[1]
  
  // // 31 - Auxiliary power enable (active LOW)
  // { PORTB, 23, PIO_DIGITAL, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // P_GROOVE


  // // User interaction
  // // ----------------------
  // // 6, 12, 10 - RGB Led controls (Red, Green, Blue)
  // { PORTA, 20, PIO_PWM, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM), No_ADC_Channel, PWM0_CH6, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // LED_RED
  // { PORTA, 19, PIO_PWM, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM), No_ADC_Channel, PWM0_CH3, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // LED_GREEN
  // { PORTA, 18, PIO_PWM, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM), No_ADC_Channel, PWM3_CH0, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // LED_BLUE

  // // 26 - TX/RX led for USB serial connection
  // { PORTA, 27, PIO_OUTPUT, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // USBLED
  ...
  // // Power management
  // // ----------------------
  // // 14, 42, 8 - Battery gauge Alarm, Charger IRQ, On the Go USB
  // { PORTA, 2, PIO_DIGITAL, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_2 },  // ALARMB
  // { PORTA, 3, PIO_DIGITAL, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_3 },  // INT_CHG
  // { PORTA, 6, PIO_DIGITAL, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER), No_ADC_Channel, PWM1_CH0, TCC1_CH0, EXTERNAL_INT_6 },        // OTG
