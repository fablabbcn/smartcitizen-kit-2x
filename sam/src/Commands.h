...
public:
    ...
    OneCom com_list[COM_COUNT] {
        ...
        OneCom {90,     COM_FLASH,          "flash",    "Shows and manage flash memory state [no-param -> info] [-format (be careful)] [-dump sect-num (0-2040)] [-sector sect-num] [-recover sect-num/all net/sd] [-read addr_hex len] [-write addr_hex hex_payload (shell mode, area must be erased)] [-erase sect-num (shell mode, 0-2047)]",  flash_com},
